    ...
    <section className="about" id="about">
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <div className="about__cta">
            <a onClick={() => scrollTo("products")} className="cta__btn cta__btn--primary" style={{cursor:"pointer"}}>Explore Products &rarr;</a>
            <a onClick={() => scrollTo("contact")} className="cta__btn cta__btn--secondary" style={{cursor:"pointer"}}>Download Catalogue</a>
          </div>
        </div>
      </div>
