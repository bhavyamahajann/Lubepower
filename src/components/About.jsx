...
//   { icon: "⚡", title: "Bulk Orders", desc: "Special pricing for wholesale & dealers", color: "yellow" },
...
//             <a href="#products" className="cta__btn cta__btn--primary">Explore Products →</a>
...
const whyUs = [
  ...
  },
  {
    ...
    desc: "Our R&D team uses cutting-edge additive technology to create lubricants that exceed international API & ACEA standards.",
    stat: "500+",
    statLabel: "Products",
    accent: "blue",
  },
    ...
    <section className="about" id="about">
      ...
      <div className="why__section">
        <div className="why__header">
          ...
          <p className="why__sub">We don't just sell lubricants — we deliver performance, protection & peace of mind.</p>
        </div>

        <div className="why__grid">
          {whyUs.map((w, i) => (
            <div className={`why__card why__card--${w.accent}`} key={i}>
