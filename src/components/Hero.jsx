      ...
      <div className="hero__container">
        <div className="hero__content">
          ...
          <div className="hero__actions">
            <a onClick={() => scrollTo("products")} className="btn btn--primary" style={{cursor:"pointer"}}>
              Explore Products
              <span className="btn__arrow">&rarr;</span>
            </a>
            <a onClick={() => scrollTo("contact")} className="btn btn--outline" style={{cursor:"pointer"}}>
              Get a Quote
            </a>
          </div>
        ...
        <div className="hero__visual">
          <div className="hero__visual-stack">
            ...
            <div className="hero__trust-card">
              ...
              <a onClick={() => scrollTo("contact")} className="hero__trust-link" style={{cursor:"pointer"}}>Talk to Our Team</a>
            </div>
          </div>
        </div>
      </div>
